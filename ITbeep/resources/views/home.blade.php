        ...
        <div class="card card-1">
            ...
            <div class="card-body">
                <form id="form" onsubmit=" event.preventDefault()" >
                    ...
                    <div class="p-t-20">
                        <button   id="submit" class="btn btn-primary btn-block" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"  >إرسال</button>
                    </div>
                    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog " role="document">
                            <div class="modal-content ">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">اختار الخدمة المناسبة</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <button  type="button" id="next-to-time" class="btn btn-primary btn-block mt-4 " onclick="NextModel()" >التالي</button>
                                </div>
